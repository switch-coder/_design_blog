...
- 데이터베이스 스키마 및 중요 변수
  ...
  - blogList, BlogMenu(GitHub API)
    ...
    | Key          | 설명                                       | 예시 값                                                                                                                                                                                                                |
    | ------------ | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
    | name         | 파일 이름                                  | "about.md", "projects.md"                                                                                                                                                                                                  |
    | path         | 파일 경로                                  | "menu/about.md", "menu/projects.md"                                                                                                                                                                                        |
    | sha          | 파일의 SHA 체크섬                          | "0953...d5b25", "7f34...f354f"                                                                                                                                                                                         |
    | size         | 파일 크기 (바이트)                         | 856, 6                                                                                                                                                                                                                 |
    | url          | 파일의 API URL                             | "https://api.github.com/repos/paullabkorea/github_blog/contents/menu/about.md?ref=main", "https://api.github.com/repos/paullabkorea/github_blog/contents/menu/projects.md?ref=main"                                        |
    | html_url     | 파일의 GitHub 페이지 URL                   | "https://github.com/paullabkorea/github_blog/blob/main/menu/about.md", "https://github.com/paullabkorea/github_blog/blob/main/menu/projects.md"                                                                            |
    ...
    | download_url | 파일을 다운로드할 수 있는 URL              | "https://raw.githubusercontent.com/paullabkorea/github_blog/main/menu/about.md", "https://raw.githubusercontent.com/paullabkorea/github_blog/main/menu/projects.md"                                                        |
    | type         | 파일 타입                                  | "file"                                                                                                                                                                                                                 |
...
- 과업
  ...
  - ~~메인 클릭했을 때 a로 이동하는 것이 아닌 projects.md 페이지로 이동하게 함으로 히스토리 유지 필요~~
  - 이미지
    - ~~favicon~~
    - ~~default 이미지~~
  ...
  - ~~블로그 figma style 반영~~
  - ~~'projects.md'파일을 어떻게 할지 (의사결정 필요)~~
  - 조회수
  - disqus 댓글
  - 한국어 가이드, 영어 가이드
...
- 애러와 애러 해결(트러블슈팅 히스토리)
  ...
  - 뒤로가기 기능 구현
    ...
    - 뒤로 갔을 때 블로그 리스트가 아니라 `projects.md` 파일을 읽어서 렌더링하는 이슈 발생
